...
export default function ActiveTimerScreen() {
  ...
  const type = (route.params as any)?.type || "tabata";
  const config = TIMER_CONFIGS[type] || TIMER_CONFIGS.tabata;
      ...
      <View className="px-8 pb-12">
        ...
        {!isStopwatch && (
          <View className="bg-gray-50 rounded-xl p-4 mb-8 flex-row items-center justify-between border border-gray-100">
            <Text className="text-xs text-gray-500 font-montserrat-bold uppercase">
              Siguiente
            </Text>
